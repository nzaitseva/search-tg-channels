...
class TlgrmRu(scrapy.Spider):
    ...
    def __init__(self, keyword=None, *args, **kwargs):
        ...
        self.keyword = keyword # явно присваиваем, можно неявно обращаться
    ...
    def parse(self, response):
        ...
        request = scrapy.Request(url,
            ...
            cb_kwargs = {'typesense_api_key': typesense_api_key}
        )

        yield request

    def parse_search_results(self,response,typesense_api_key):
        ...
        # request results for the rest of the pages if the fist page
